    ...
    namespace Better_Cshark
    {
        public class Battle
        {
                ...
                if (playerFirst)
                    {
                        // Tour du joueur
                        Console.WriteLine("\nTour du joueur :");
                    PlayerTurn(playerData, mobData, choice) ;
                        if (mobData.PV <= 0 || choice == "4") break;
                    ...
                    else
                    {
                        ...
                        Console.WriteLine("\nTour de l'adversaire :");
                        EnemyTurn(mobData, playerData);
                        if (playerData.PV <= 0 || choice == "4") break;
            ...
            public static void PlayerTurn(Entity player, Entity enemy, string choice)
            {
                switch (choice)
                {
                    case "1":
